...
export const icons = {
  ...
  star: () => icon('<path d="M12 3.5 14.7 9.4 21 10.2l-4.6 4.4 1.2 6.2-5.6-3-5.6 3 1.2-6.2L3 10.2l6.3-.8z"/>'),
  "star-full": () =>
    icon(
      '<path d="M12 3.5 14.7 9.4 21 10.2l-4.6 4.4 1.2 6.2-5.6-3-5.6 3 1.2-6.2L3 10.2l6.3-.8z" fill="currentColor"/>',
    ),
};
